...
$string['apierror']                 = 'Erreur de la plateforme LiveStream : {$a}';
$string['roomreset_backendchanged'] = 'L\'adresse de la plateforme LiveStream a changé depuis la création de cette salle : l\'ancienne salle appartenait à un autre serveur. Le lien a été réinitialisé — un modérateur peut recréer la salle sur la plateforme actuelle.';
$string['roomreset_roommissing']    = 'La salle associée n\'existe plus sur la plateforme LiveStream (supprimée ou créée sur un autre serveur). Le lien a été réinitialisé — un modérateur peut la recréer.';
$string['errorconnection']          = 'Impossible de contacter la plateforme LiveStream (problème réseau ou serveur indisponible). Réessayez dans quelques instants ; si le problème persiste, contactez l\'administrateur.';
$string['errornotenrolled']         = 'Vous n\'avez pas (encore) de droits de modérateur sur la plateforme LiveStream ({$a}). Connectez-vous au moins une fois sur la plateforme, ou contactez l\'administrateur pour obtenir les droits nécessaires.';
$string['errorratelimit']           = 'Trop de tentatives. Veuillez patienter une minute avant de réessayer.';
