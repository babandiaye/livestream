...
/**
 * Event triggered when a new LiveStream room is created.
 */
class room_created extends \core\event\base {
    ...
    public static function get_name(): string {
        return get_string('event_room_created', 'mod_livestream');
    }

    public function get_description(): string {
        return "The user with id '{$this->userid}' created a new LiveStream room " .
